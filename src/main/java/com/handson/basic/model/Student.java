...
public class Student implements Serializable {
    ...
    /*
    CascadeType.REMOVE - if a student is deleted, delete all their grades from the grades table.
    CascadeType.PERSIST - if a student has their ID changed, change their ID in the grade table as well.
     */
